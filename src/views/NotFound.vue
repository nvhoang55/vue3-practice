    ...
    <div class="left-section">
      <div class="inner-content">
        ...
        <div class="btn-container d-flex justify-content-center mt-4">
          <router-link :to="{ name: 'AllChar'}" class="btn btn-outline-light">Back</router-link>
        </div>
      </div>
    </div>
    <div class="right-section">
      <svg class="svgimg" viewBox="51.5 -15.288 385 505.565" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="lamp">
          ...
          <radialGradient id="SVGID_1_" class="light-gradient" cx="119.676" cy="44.22" gradientUnits="userSpaceOnUse"
                          r="65">
            <stop offset="0%" style="stop-color:#FFFFFF; stop-opacity: 1"/>
            <stop offset="50%" style="stop-color:#EDEDED; stop-opacity: 0.5">
              <animate attributeName="stop-opacity" dur="5000ms" repeatCount="indefinite"
